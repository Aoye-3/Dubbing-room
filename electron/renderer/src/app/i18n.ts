export const messages = {
  en: {
    ...
    starting: "Starting Dubbing-room AppShell",
    ...
    allFavorites: "All",
    withFavorite: "Starred",
    withoutFavorite: "Unstarred",
    ...
    updatePageTitle: "GitHub Updates",
    updateRepository: "GitHub Repository",
    updateBranch: "Branch",
    checkUpdates: "Check",
    checkingUpdates: "Checking",
    fetchUpdates: "Fetch",
    fetchingUpdates: "Fetching",
    ...
    dirtyFiles: "Dirty tracked files",
    noDirtyFiles: "No dirty tracked files.",
    updateLog: "Log",
    noUpdateLog: "No log entries.",
  ...
  zh: {
    ...
    updatePageTitle: "GitHub 更新",
    updateRepository: "GitHub 仓库",
    updateBranch: "分支",
    checkUpdates: "检查",
    checkingUpdates: "检查中",
    fetchUpdates: "拉取",
    ...
    ignored: "已忽略",
    notIgnored: "未忽略",
    updateDiagnostics: "诊断",
    blockers: "阻塞原因",
    noBlockers: "没有阻塞项。",
    dirtyFiles: "已跟踪改动",
    noDirtyFiles: "没有已跟踪改动。",
    updateLog: "日志",
    noUpdateLog: "暂无日志。",
    restartRequired: "更新已应用。请在方便时重启 AppShell。",
  },
} as const;
